  ...
  return (
    <div className="fade-in">
        ...
        {items.map((item, idx) => (
          <div key={idx}>
            ...
            >
              ...
              <div style={{ textAlign: 'center', fontSize: '12px', color: '#aaa', padding: '8px 4px' }} onClick={e => e.stopPropagation()}>
                {item.name ? item.series.length : '—'}
              </div>
              <div style={{ textAlign: 'center', fontSize: '12px', color: '#aaa', padding: '8px 4px' }} onClick={e => e.stopPropagation()}>
                {item.series[0]?.reps || '—'}
              </div>
              <div style={{ textAlign: 'center', fontSize: '12px', color: '#4ade80', fontWeight: 700, padding: '8px 4px' }} onClick={e => e.stopPropagation()}>
            ...
            {item.expanded && (
              <div style={{ background: '#0d0d0d', borderBottom: '1px solid rgba(255,255,255,0.07)', padding: '10px 12px' }}>
      ...
      <div style={{ display: 'flex', gap: '8px', marginBottom: '14px' }}>
        ...
        <button className="btn sm" style={{ flex: 1 }} onClick={() => { setAddingTo(null); setShowLib(true) }}>Abrir biblioteca</button>
      </div>
