...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const prompt = `Eres un coach de fitness profesional. Analiza la evolución de composición corporal y escribe UN párrafo de 3 a 4 oraciones en español, sin tecnicismos, que resuma el progreso general, las tendencias más importantes y una recomendación concreta. Sé directo y motivador.
